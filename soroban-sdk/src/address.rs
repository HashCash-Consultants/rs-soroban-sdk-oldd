...
/// authorization.
///
/// Internally, Address may represent a Hcnet account or a contract. Contract
...
impl Address {
    ...
    /// Creates an `Address` corresponding to the provided Hcnet strkey.
    ///
    ...
    /// Creates an `Address` corresponding to the provided Hcnet strkey bytes.
    ///
