...
impl Env {
    ...
    /// Register the built-in Hcnet Asset Contract with provided admin address.
    ///
    /// Returns the contract ID of the registered token contract.
    ///
    /// The contract will wrap a randomly-generated Hcnet asset. This function
    ...
    pub fn register_hcnet_asset_contract(&self, admin: Address) -> Address {
        ...
        let create = xdr::HostFunction::CreateContract(xdr::CreateContractArgs {
            ...
            executable: xdr::ContractExecutable::HcnetAsset,
        });
