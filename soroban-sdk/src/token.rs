...
//!
//! Use [`TokenClient`] for calling token contracts such as the Hcnet Asset
//! Contract.
...
/// Interface for Token contracts, such as the Hcnet Asset Contract.
///
/// Defined by [SEP-41].
///
/// [SEP-41]: https://github.com/hcnet/hcnet-protocol/blob/master/ecosystem/sep-0041.md
///
...
/// the next.
#[contractspecfn(name = "HcnetAssetSpec", export = false)]
...
/// Interface for admin capabilities for Token contracts, such as the Hcnet
/// Asset Contract.
#[contractspecfn(name = "HcnetAssetSpec", export = false)]
#[contractclient(crate_path = "crate", name = "HcnetAssetClient")]
pub trait HcnetAssetInterface {
...
/// interface, as well as the admin interface, such as the Hcnet Asset
/// Contract.
#[doc(hidden)]
pub struct HcnetAssetSpec;

pub(crate) const SPEC_XDR_INPUT: &[&[u8]] = &[
    &HcnetAssetSpec::spec_xdr_allowance(),
    &HcnetAssetSpec::spec_xdr_authorized(),
    &HcnetAssetSpec::spec_xdr_approve(),
    &HcnetAssetSpec::spec_xdr_balance(),
    &HcnetAssetSpec::spec_xdr_burn(),
    &HcnetAssetSpec::spec_xdr_burn_from(),
    &HcnetAssetSpec::spec_xdr_clawback(),
    &HcnetAssetSpec::spec_xdr_decimals(),
    &HcnetAssetSpec::spec_xdr_mint(),
    &HcnetAssetSpec::spec_xdr_name(),
    &HcnetAssetSpec::spec_xdr_set_admin(),
    &HcnetAssetSpec::spec_xdr_admin(),
    &HcnetAssetSpec::spec_xdr_set_authorized(),
    &HcnetAssetSpec::spec_xdr_symbol(),
    &HcnetAssetSpec::spec_xdr_transfer(),
    &HcnetAssetSpec::spec_xdr_transfer_from(),
];
